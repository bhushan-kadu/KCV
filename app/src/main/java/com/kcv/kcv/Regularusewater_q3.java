...
public class Regularusewater_q3 extends Activity {
    SeekBar sBar;
    TextView tView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regularusewater_q3);
        ...
        next1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(i==0){
                    ...
                    Intent intent=new Intent(getApplicationContext(),Regularusewater_q4.class);
