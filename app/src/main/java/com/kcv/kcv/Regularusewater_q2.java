...
public class Regularusewater_q2 extends AppCompatActivity {
    SeekBar sBar;
    TextView tView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regularusewater_q2);
        ...
        SharedPreferences pref1 = getApplicationContext().getSharedPreferences("Options2", MODE_PRIVATE);
        editor = pref1.edit();
        ...
        save1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SharedPreferences pref1 = getApplication().getSharedPreferences("Options2", MODE_PRIVATE);
                String and=pref1.getString("marks2", "");
                pval= pval+Integer.parseInt(and);

                i=1;
                editor.putString("marks2", String.valueOf(pval));
                editor.commit();
        ...
        next1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(i==0){
                    ...
                    Intent intent=new Intent(getApplicationContext(),Regularusewater_q3.class);
