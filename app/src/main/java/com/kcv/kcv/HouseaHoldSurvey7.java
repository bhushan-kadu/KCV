...
public class HouseaHoldSurvey7 extends AppCompatActivity {
    private Bundle b ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_housea_hold_survey7);
        ...
        linearLayout = findViewById(R.id.householdSurvey7);
    ...
    public void reg(View view) {
        ...
        Intent intent=new Intent(view.getContext(),HouseaHoldSurvey8.class);
