...
public class HouseaHoldSurvey4 extends AppCompatActivity {
    private Bundle b ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_housea_hold_survey4);
        b = this.getIntent().getExtras();
        if(b!= null){
            params = (HashMap<String, String>) b.getSerializable("form-params");
            count = b.getInt("count");
        }
        linearLayout = findViewById(R.id.householdSurvey4);
    ...
    public void reg(View view) {
        ...
        Intent intent=new Intent(view.getContext(),HouseaHoldSurvey5.class);
