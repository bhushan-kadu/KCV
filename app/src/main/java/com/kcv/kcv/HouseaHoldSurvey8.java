...
public class HouseaHoldSurvey8 extends AppCompatActivity {
    private Bundle b ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_housea_hold_survey8);
        ...
        linearLayout = findViewById(R.id.householdSurvey8);
    ...
    public void reg(View view) {
        ...
        Intent intent=new Intent(view.getContext(),HouseaHoldSurvey9.class);
