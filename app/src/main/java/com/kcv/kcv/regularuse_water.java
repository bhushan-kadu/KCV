...
public class regularuse_water extends AppCompatActivity {
    SeekBar sBar;
    TextView tView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regularuse_water);
        ...
        next1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(i==0){
                    ...
                    Intent intent=new Intent(getApplicationContext(),Regularusewater_q2.class);
