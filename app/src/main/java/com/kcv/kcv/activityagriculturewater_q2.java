...
public class activityagriculturewater_q2 extends AppCompatActivity {
    SeekBar sBar;
    TextView tView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activityagriculturewater_q2);
        ...
        next1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(i==0){
                    ...
                    Intent intent=new Intent(getApplicationContext(),acticityagriculturewater_q3.class);
