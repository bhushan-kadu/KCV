...
public class drinkingwater_q4 extends AppCompatActivity {
    SeekBar sBar;
    TextView tView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drinkingwater_q4);
        ...
        next1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (i == 0) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), drinkingwater_q5.class);
