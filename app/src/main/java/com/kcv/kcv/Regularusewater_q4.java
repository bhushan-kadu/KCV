...
public class Regularusewater_q4 extends AppCompatActivity {
    SeekBar sBar;
    TextView tView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regularusewater_q4);
        ...
        next1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(i==0){
                    ...
                    Intent intent=new Intent(getApplicationContext(),Regularusewater_q5.class);
